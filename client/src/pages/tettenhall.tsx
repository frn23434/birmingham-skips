...
export default function Tettenhall() {
  ...
  useMetaTags({
    title: "Skip Hire Tettenhall | Fast & Reliable Waste Removal",
    description: "Professional skip hire services in Tettenhall, Wolverhampton. All sizes available, same day delivery. Fully licensed & insured. Message us on WhatsApp: 07900 717881",
    keywords: "skip hire Tettenhall, Tettenhall skip hire, waste removal Tettenhall, skip rental Tettenhall, cheap skip hire Tettenhall, same day skip delivery Tettenhall",
    ogTitle: "Skip Hire Tettenhall | Fast & Reliable Waste Removal",
    ogDescription: "Professional skip hire services in Tettenhall. All sizes available, same day delivery. Message us on WhatsApp for a quote!",
    twitterTitle: "Skip Hire Tettenhall | Wolverhampton",
    twitterDescription: "Professional skip hire in Tettenhall. Same day delivery, all sizes. Message on WhatsApp for a fast quote!",
  });
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="text-white">
              ...
              <p className="text-xl md:text-2xl text-blue-100 mb-8" data-testid="text-hero-subtitle">
                Fast, reliable skip hire services in Tettenhall. All sizes available with same day delivery across the area.
              </p>
      ...
      <section id="skip-sizes" className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-4" data-testid="text-sizes-title">Skip Sizes Available in Tettenhall</h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">Choose the right skip size for your project in Tettenhall. Not sure which size you need? Message us on WhatsApp and we'll help!</p>
          </div>
      ...
      <section className="py-20 bg-card">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-4xl font-bold mb-6" data-testid="text-why-title">Why Choose Us for Tettenhall Skip Hire?</h2>
              <p className="text-lg text-muted-foreground mb-6">
                We're your trusted local skip hire provider serving Tettenhall and the surrounding areas. With competitive prices, reliable service, and a range of skip sizes to suit any project, we make waste disposal simple and stress-free.
              </p>
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-4 p-4 bg-background rounded-lg">
                  ...
                  <div>
                    <h3 className="font-semibold text-lg mb-1">Fast Delivery to Tettenhall</h3>
                    <p className="text-muted-foreground">Same day delivery available across Tettenhall and nearby areas</p>
                  </div>
                </div>
                <div className="flex items-start gap-4 p-4 bg-background rounded-lg">
      ...
      <section className="py-20 bg-gradient-to-br from-primary/5 to-primary/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold mb-4" data-testid="text-areas-title">Tettenhall & Surrounding Areas</h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">Skip hire services across Tettenhall and nearby postcodes</p>
          </div>
      ...
      <section className="py-20 bg-card">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-br from-green-500 to-green-700 rounded-2xl p-12 text-center text-white">
            ...
            <h3 className="text-3xl font-bold mb-4" data-testid="text-cta-title">Get Your Tettenhall Skip Quote Today</h3>
